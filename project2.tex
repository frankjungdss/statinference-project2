...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{cat}\NormalTok{(}\KeywordTok{range}\NormalTok{(tg$len))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{by}\NormalTok{(tg, tg$dose,}
   \NormalTok{function (x) }\KeywordTok{t.test}\NormalTok{(len ~}\StringTok{ }\NormalTok{supp, x, }\DataTypeTok{paired =} \NormalTok{F, }\DataTypeTok{var.equal =} \NormalTok{F, }\DataTypeTok{alternative =} \StringTok{"t"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}

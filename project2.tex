...
In this analysis we assume that the supplement and variances are
independent, and the data is assumed to be normally distributed.
...
\(H_0 : \mu_{oj} = \mu_{vc}\) and \(H_a : \mu_{oj} \ne \mu_{vc}\) is our
alternative hypothesis.

For each dose, compare lengths from each supplement. Show just the
...
\toprule
Dosage (milligrams) & Comparison of lengths between
